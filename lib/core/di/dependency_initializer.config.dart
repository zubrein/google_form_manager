...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i16.UserAuthenticationRepository>(
        () => _i17.UserAuthRepositoryImpl());
    gh.factory<_i18.BatchUpdateUseCase>(
        () => _i18.BatchUpdateUseCase(gh<_i7.EditFormRepository>()));
    gh.factory<_i19.CreateFormCubit>(() => _i19.CreateFormCubit(
          createFormUseCase: gh<_i6.CreateFormUseCase>(),
          batchUpdateUseCase: gh<_i18.BatchUpdateUseCase>(),
        ));
    gh.factory<_i20.DeleteFormListUseCase>(() =>
        _i20.DeleteFormListUseCase(repository: gh<_i12.FormListRepository>()));
    gh.factory<_i21.FetchFormListUseCase>(() =>
        _i21.FetchFormListUseCase(repository: gh<_i12.FormListRepository>()));
    gh.factory<_i22.FormCubit>(() => _i22.FormCubit(
          gh<_i10.FetchFormUseCase>(),
          gh<_i3.CheckQuestionTypeUseCase>(),
          gh<_i9.FetchFormResponsesUseCase>(),
          gh<_i18.BatchUpdateUseCase>(),
          gh<_i11.FetchYoutubeListUseCase>(),
        ));
    gh.factory<_i23.LogoutUseCase>(() => _i23.LogoutUseCase(
        repository: gh<_i16.UserAuthenticationRepository>()));
    gh.factory<_i24.SigningInUseCase>(() => _i24.SigningInUseCase(
        repository: gh<_i16.UserAuthenticationRepository>()));
    gh.factory<_i25.LoginCubit>(() => _i25.LoginCubit(
          gh<_i24.SigningInUseCase>(),
          gh<_i23.LogoutUseCase>(),
        ));
    gh.factory<_i26.FormListCubit>(() => _i26.FormListCubit(
          gh<_i21.FetchFormListUseCase>(),
          gh<_i20.DeleteFormListUseCase>(),
          gh<_i25.LoginCubit>(),
        ));
    return this;
  }
